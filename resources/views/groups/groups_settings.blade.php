...
<div class="row " style="border-radius : 15px; padding : 10px; width : 98%; border: 3px solid rgba(0,0,0,.1); background-color : rgba(255,255,255,0.5) ">
<h3 class="grey-text"> <i class="knocks-settings5"></i> Group settings</h3>
    <knocksgroupsettings :group_object="{{$group}}"></knocksgroupsettings>
  </div>
