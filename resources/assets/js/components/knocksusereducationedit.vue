...
<div class = "row">
	...
	<div class="col s12 l4">
        ...
        el_follower
        :mat_follower=  "false"
				:start_as="educationObject.study_at"
...
const vm = this ;
setTimeout(()=>{
	vm.study_since_e = vm.educationObject.study_since;
	vm.study_to_e = vm.educationObject.study_to;
	vm.study_at_e = vm.educationObject.study_at;
	vm.study_what_e = vm.educationObject.study_what;
	vm.grade_e = vm.educationObject.grade;
	vm.education_id= vm.educationObject.id;
