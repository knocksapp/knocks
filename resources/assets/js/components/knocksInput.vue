...
<div class = "row">
  <div class = "s9">
    <div class="input-field knocks_input_holder_ps">
      ...
      <i v-else  class="material-icons prefix " :class = "{'knocks_text_dark_active' : focus} ">
    ...
    export default {
       ...
       samilarity_icon : {
        ...
        methods : {
          ...
          notEmpty(){
            return this.value == null || this.value == "" || this.value.length == 0 ? false : true ;
          } ,
          is_numericValid(){
            return isNaN(this.value) != this.is_numeric ? true : false ;
          },
          maxValid(){
          ...
          max_lenValid(){
            return this.value.length <= this.max_len ? true : false;
          },
          min_lenValid(){
            return this.value.length >= this.min_len ? true : false;
          },
          regexValid(){
